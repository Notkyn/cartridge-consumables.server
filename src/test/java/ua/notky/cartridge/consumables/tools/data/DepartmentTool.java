...
public class DepartmentTool {
    ...
    public static final Department DEPARTMENT_2 = new Department(ID_DEPARTMENT_2, "department_1");
    public static final Department DEPARTMENT_3 = new Department(3, "department_1");
    public static final Department DEPARTMENT_4 = new Department(4, "department_1");
    public static final Department DEPARTMENT_5 = new Department(5, "department_1");

    public static List<Department> DEPARTMENTS = List.of(DEPARTMENT_1, DEPARTMENT_2, DEPARTMENT_3, DEPARTMENT_4, DEPARTMENT_5);
